      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 relative z-10 pt-8 sm:pt-10 md:pt-16 lg:pt-20 pb-6 md:pb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-10">
          ...
          <div className="flex gap-4 md:gap-5 items-center md:items-start lg:justify-end pt-4 md:pt-0">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/stalight-technology-45391a378?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#0077b5] transition-all duration-300 transform hover:scale-110" aria-label="LinkedIn">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
            </a>

            {/* Instagram */}
            <a href="https://www.instagram.com/stalight_technology?igsh=N3hhZ2d6aDl6ZmFp" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#e1306c] transition-all duration-300 transform hover:scale-110" aria-label="Instagram">
